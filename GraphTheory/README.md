...
![Graph Theory Result: A cross-correlation matrix is converted into a thresholded adapted weighted matrix. Then, this adapted matrix is converted into an undirected, weighted graph. Here, graph theory metrics can be extracted from the resulting graph.](Graph_Theory_20250326_fish2.jpg)
